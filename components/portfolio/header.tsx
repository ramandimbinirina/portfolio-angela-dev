  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <nav 
          className={`relative transition-all duration-500 rounded-2xl flex items-center justify-between px-6 py-2.5 bg-background/20 backdrop-blur-md border border-primary/10 shadow-2xl ${
            isScrolled
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold tracking-tight text-foreground dark:text-white leading-none">
                Angela RAMANDIMBINIRINA
              </span>
